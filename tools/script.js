...
const SL=[
 ...
 ['8','본론 5 · 기기 · IoT 연동','25초','판정은 앱 한 곳에서 하고, 표현은 세 곳으로 나눕니다. 같은 판정이 기기 LCD에 그대로 뜨고, IoT 스피커가 유형별 문장을 읽어줍니다. 심야나 낮잠 시간대에는 소리를 끄고 화면 안내만 남깁니다. 네트워크가 없어도 전 구간 동작합니다.','AI·IoT 적용 수준을 보는 장 — 기술 구현 35점의 축. 천천히.'],
 ...
 ['10','결론 2 · AX 활용','30초','AI는 판단이 필요한 다섯 자리에 들어갔습니다. 유형 추론, 여유 시간 예측, 수명 반영, 잔차 진단으로 식 수정, 상황 인지와 IoT 연동. 사용자 입장에서는 전부 “안 해도 되는 일”이 됐습니다. 개발 과정 자체도 Claude Code로 1년치 사용 이력을 반복 분석했습니다.','가장 중요한 장. 왼쪽 읽고 오른쪽으로 넘기며 말하기.'],
...
body.push(table([
 ...
 ['기술 구현 및 완성도 (35)','7장 SOH · 8장 기기·IoT 연동 · 데모의 동작 안정성'],
...
const QA=[
 ...
 ['AI·IoT를 구체적으로 어디에 적용했나?','판단이 필요한 다섯 지점 — 유형 추론, 소모율 예측, 수명 반영, 잔차 진단 기반 식 수정, 상황 인지 무음. IoT는 앱 판정을 기기 LCD와 스피커로 동시 전달하는 구조로 적용.'],
